...
let biografia = await conn.fetchStatus('50231458537' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `𝐄𝐥•𝐁𝐫𝐚𝐲𝐚𝐧𝐘𝐓`, dev, correo, `🇬🇹 Guatemala`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Un Bot 🐉`, `${packname}`, `📵 No Hacer Spam`, correo, `🇬🇹 Guatemala`, md, biobot]
], m)
