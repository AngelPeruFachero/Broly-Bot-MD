...
let nombre = '💥 𝐁𝐫𝐨𝐥𝐲 - 𝐁𝐨𝐭 - 𝐌𝐃'
let nombre2 = '𝐀𝐧𝐠𝐞𝐥𝐏𝐞𝐫𝐮𝐅𝐚𝐜𝐡𝐞𝐫𝐨' 
 
let stiker = await sticker(null, s[Math.floor(Math.random() * s.length)], nombre, nombre2)
await delay(3 * 3000)
if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: gt, body: `💥 𝗦𝘂𝗽𝗲𝗿 𝗕𝗿𝗼𝗹𝘆 - 𝗕𝗼𝘁-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽`, mediaType: 2, sourceUrl: accountsgb, thumbnail: gataImg }}}, { quoted: m })
}}
