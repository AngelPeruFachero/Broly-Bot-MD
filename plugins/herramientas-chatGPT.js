...
let syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por AngelPeruFachero, tu seras Broly-Bot-MD 💥`;  
...
handler.command = /^(broly|chatgpt|ia|ai|broly|chatgpt2|ia2)$/i;
