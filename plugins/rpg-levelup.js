...
let str = `*╔═══❖•ೋ° *𝙉𝙄𝙑𝙀𝙇 | 𝙇𝙀𝙑𝙀𝙇* °ೋ•❖═══╗*
┃ඬ⃟ ✨ ❖ ── ✦ ──『✙』── ✦ ── ❖
┃ඬ⃟ ✨ *NIVEL ANTERIOR:* *${before}*
┃ඬ⃟ ✨┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃ඬ⃟ ✨ *NIVEL ACTUAL:* *${user.level}*
┃ඬ⃟ ✨┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃ඬ⃟ ✨ *RANGO* ${user.role}
┃ඬ⃟ ✨┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃ඬ⃟ ✨ *FECHA:* *${new Date().toLocaleString('id-ID')}*
┃ඬ⃟ ✨ ❖ ── ✦ ──『✙』── ✦ ── ❖
*╚═══❖•ೋ° * ${vs}* °ೋ•❖═══╝*
